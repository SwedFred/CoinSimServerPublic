...
{
  // Den här klassen fungerar som ett API mot CoinGecko. De har egentligen ett eget bibliotek men jag känner att det blir överflödigt med tanke på vilken begränsad funktionalitet jag vill ha.
  public class CoinGecko
  {
    ...
    public List<Cryptocoin> GetCurrencies()
    {
      if (coinCache.Any())
        return coinCache;
      else
